...
import { getPersonDetails,getPersonCombinedCredits,getPersonImages,getPersonMovies,getPersonTVShows,getTrendingPerson } from '../controllers/person.controller.js';
...
router.get('/trending', getTrendingPerson);
